-- Complete AI Learning Content Collection
...
INSERT INTO ai_learning_content (
  title, content_type, content, summary, author_company, author_name,
  version, tags, category, difficulty, is_nvidia_content
) VALUES (
...
INSERT INTO ai_learning_content (
  title, content_type, content, summary, author_company, author_name,
  version, tags, category, difficulty
) VALUES (
...
## Core Concept
Constitutional AI (CAI) is a method for training AI systems to be helpful, harmless, and honest by using a constitution - a set of principles that guide the AI''s behavior.
